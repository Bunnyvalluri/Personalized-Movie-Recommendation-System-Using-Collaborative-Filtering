...
import { Globe, Mail, Library, Link as LinkIcon, MessageSquare } from 'lucide-react';
    ...
    <footer className="bg-transparent pt-24 pb-12 px-6 lg:px-16 border-t border-white/5">
      <div className="max-w-[1920px] mx-auto grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-16">
        <div className="col-span-2 space-y-6">
          ...
          <p className="text-sm text-white/40 max-w-xs leading-relaxed font-inter">
          ...
          <div className="flex gap-4">
             <MessageSquare className="h-5 w-5 text-white/20 hover:text-white cursor-pointer transition" />
             <Mail className="h-5 w-5 text-white/20 hover:text-white cursor-pointer transition" />
             <Library className="h-5 w-5 text-white/20 hover:text-white cursor-pointer transition" />
             <LinkIcon className="h-5 w-5 text-white/20 hover:text-white cursor-pointer transition" />
          </div>
        </div>

        <div>
          <h4 className="text-white font-black text-xs mb-6 uppercase tracking-[0.2em] opacity-40">Platform</h4>
        ...
        <div>
           <h4 className="text-white font-black text-xs mb-6 uppercase tracking-[0.2em] opacity-40">Company</h4>
           <ul className="space-y-4 text-sm text-white/40 font-medium">
        ...
        <div>
           <h4 className="text-white font-black text-xs mb-6 uppercase tracking-[0.2em] opacity-40">Support</h4>
           <ul className="space-y-4 text-sm text-white/40 font-medium">
      ...
      <div className="max-w-[1920px] mx-auto pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] text-white/20 font-black tracking-[0.3em] uppercase">
